 ...
 * ID del usuario, del grupo y de la tarea actual, así como el nombre del
 * usuario.
 */
public class CurrentSession {
    ...
    private int userRole;      // Rol del usuario logueado
    ...
    ////// Métodos para gestionar el rol del usuario
