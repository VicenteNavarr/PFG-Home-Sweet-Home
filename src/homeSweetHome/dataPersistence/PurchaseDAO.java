...
//                       ListaCompra.fecha, ListaCompra.id_grupo, Inventario.nombre_producto, ListaCompra.tipo
//                FROM ListaCompra
...
//            stmt.setString(3, purchase.getTipo()); // Nuevo campo "tipo"
//            stmt.setString(4, purchase.getFecha());
//            stmt.setInt(5, purchase.getIdGrupo());
//
...
//            stmt.setString(2, purchase.getTipo()); // Nuevo campo "tipo"
